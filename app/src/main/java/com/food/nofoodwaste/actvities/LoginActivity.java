...
*/
    ...
    private void sendvolunteer(){
        String phoneNo = "8056371394";
        String volname = edtName.getText().toString();
        String volnum= edtPhone.getText().toString();
        String voldetails="Volunteer Name:"+volname+"\nContact:"+volnum;
        try {
            SmsManager smsManager = SmsManager.getDefault();
            smsManager.sendTextMessage(phoneNo, null, voldetails, null, null);
            Toast.makeText(getApplicationContext(), "Thank you for being Volunteer!",
